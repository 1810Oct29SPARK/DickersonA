...
public class Car extends Vehicle {
	...
	public Car(int yearManufactured, String model, String make) {
			//this refers to car object being created NOT the argument
	...
	private String make;
	private int milesSinceOilChange; //this instance variable tracks how many miles since last oilchange
	...
	public void setMilesSinceOilChange(milesSinceOilChange){
